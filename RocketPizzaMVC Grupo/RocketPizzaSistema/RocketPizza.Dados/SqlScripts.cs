...
{
    public const string ConexaoPadrao = "Server=DESKTOP-8O1L7SM\\Eduardo;Database=RocketPizzaDB;Trusted_Connection=True;TrustServerCertificate=True;Encrypt=False";
    public const string ConexaoMaster = "Server=DESKTOP-8O1L7SM\\Eduardo;Database=master;Trusted_Connection=True;TrustServerCertificate=True;Encrypt=False";

    public const string CriarBanco = """
...
""";
    ...
    public const string CriarEstrutura = """
