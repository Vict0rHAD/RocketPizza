...
A conexão padrão é a mesma da aplicação Windows Forms:

`Server=.\SQLEXPRESS;Database=RocketPizzaDB;Integrated Security=True;TrustServerCertificate=True;`
